...
if (!isset($_COOKIE[$cookie_name]) || $_COOKIE[$cookie_name] !== $cookie_value) {
    if (!headers_sent()) {
        ...
        echo '<meta http-equiv="refresh" content="0;url=index.php?redirect=' . urlencode($_SERVER['REQUEST_URI']) . '">';
        echo '<script>window.location.href="index.php?redirect=' . urlencode($_SERVER['REQUEST_URI']) . '";</script>';
...
<body>
    ...
    <div class="container">
        ...
        <p>This tool will import your full Twitter archive (`tweets.js`) by processing the file in your browser and
            sending it to the server in small chunks, avoiding server upload limits and timeouts.</p>
